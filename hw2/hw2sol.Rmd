...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(bicarbonate),
            Q1 = quantile(bicarbonate, 0.25),
            median = median(bicarbonate, na.rm = TRUE),
            Q3 = quantile(bicarbonate, 0.75),
            max = max(bicarbonate))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(creatinine),
            Q1 = quantile(creatinine, 0.25),
            median = median(creatinine, na.rm = TRUE),
            Q3 = quantile(creatinine, 0.75),
            max = max(creatinine))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(potassium),
            Q1 = quantile(potassium, 0.25),
            median = median(potassium, na.rm = TRUE),
            Q3 = quantile(potassium, 0.75),
            max = max(potassium))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(sodium),
            Q1 = quantile(sodium, 0.25),
            median = median(sodium, na.rm = TRUE),
            Q3 = quantile(sodium, 0.75),
            max = max(sodium))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(hematocrit),
            Q1 = quantile(hematocrit, 0.25),
            median = median(hematocrit, na.rm = TRUE),
            Q3 = quantile(hematocrit, 0.75),
            max = max(hematocrit))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(`white blood cell count`),
            Q1 = quantile(`white blood cell count`, 0.25),
            median = median(`white blood cell count`, na.rm = TRUE),
            Q3 = quantile(`white blood cell count`, 0.75),
            max = max(`white blood cell count`))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(calcium),
            Q1 = quantile(calcium, 0.25),
            median = median(calcium, na.rm = TRUE),
            Q3 = quantile(calcium, 0.75),
            max = max(calcium))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(magnesium),
            Q1 = quantile(magnesium, 0.25),
            median = median(magnesium, na.rm = TRUE),
            Q3 = quantile(magnesium, 0.75),
            max = max(magnesium))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(`heart rate`),
            Q1 = quantile(`heart rate`, 0.25),
            median = median(`heart rate`, na.rm = TRUE),
            Q3 = quantile(`heart rate`, 0.75),
            max = max(`heart rate`))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            standard_deviation = sd(`systolic non-invasive blood pressure`,
                                    na.rm = TRUE),
            min = min(`systolic non-invasive blood pressure`),
            Q1 = quantile(`systolic non-invasive blood pressure`, 0.25),
            median = median(`systolic non-invasive blood pressure`,
                            na.rm = TRUE),
            Q3 = quantile(`systolic non-invasive blood pressure`, 0.75),
            max = max(glucose))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            standard_deviation = sd(`mean non-invasive blood pressure`,
                                    na.rm = TRUE),
            min = min(`mean non-invasive blood pressure`),
            Q1 = quantile(`mean non-invasive blood pressure`, 0.25),
            median = median(`mean non-invasive blood pressure`,
                            na.rm = TRUE),
            Q3 = quantile(`mean non-invasive blood pressure`, 0.75),
            max = max(`mean non-invasive blood pressure`))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            min = min(`respiratory rate`),
            Q1 = quantile(`respiratory rate`, 0.25),
            median = median(`respiratory rate`, na.rm = TRUE),
            Q3 = quantile(`respiratory rate`, 0.75),
            max = max(`respiratory rate`))
...
mimic_icu_cohort %>% 
  ...
  summarise(n = n(),
            ...
            standard_deviation = sd(`body temperature in Fahrenheit`, 
                                    na.rm = TRUE),
            min = min(`body temperature in Fahrenheit`),
            Q1 = quantile(`body temperature in Fahrenheit`, 0.25),
            median = median(`body temperature in Fahrenheit`, 
                            na.rm = TRUE),
            Q3 = quantile(`body temperature in Fahrenheit`, 0.75),
            max = max(`body temperature in Fahrenheit`))
```
