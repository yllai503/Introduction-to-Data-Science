...
```
The histograms of each lab measurements are shown below. We can notice that a lot of outliers exist in some variables: `creatinine`, `white blood cell count`, `calcium`, `magnesium`, and `glucose`, and make distributions of these variables severely right skewed. We may want to examine the data further, and decide whether excluding these outliers or doing transformation to better evaluate our data.
